...
namespace Tamagotchi.View
{
    public class TamagotchiView
    {
        ...
        public void ListarPokemonsDisponiveis(List<PokemonSpeciesResult> listaPokemons){
            Console.WriteLine("-------------ESPÉCIES DISPONÍVEIS--------------");
            var i = 1;
        ...
        public void ListarDescricaoDoPokemon(PokemonDetails pokemonDetails){
            Console.WriteLine("-------------INFORMAÇÕES DO MASCOTE-------------");
        ...
        public void MenuDeInteracaoComMascote(){
            Console.WriteLine("--------------INTERAGIR COM MASCOTE--------------");
            ...
            Console.WriteLine("5- Levar mascote ao veterinário");
        ...
        public void ListarMascotesAdotados(List<TamagotchiDto> mascotesAdotados){
            var contador = 1;
            Console.WriteLine("---------------LISTA DE MASCOTE-------------");
            if(mascotesAdotados.Any()){}
            foreach(var mascote in mascotesAdotados){
             Console.WriteLine($"{contador ++} - {mascote.Nome.ToUpper()}");
            }
        }
